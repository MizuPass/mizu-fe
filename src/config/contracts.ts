...
// MJPY Token Contract Configuration
export const MJPY_TOKEN_ADDRESS: Address = '0x115e91ef61ae86FbECa4b5637FD79C806c331632'
...
export const MIZU_EVENT_REGISTRY_ADDRESS: Address = '0x8A3f8d775f06251436eAA46739B57C03b51eb193'
...
export const EVENT_REGISTRY_FUNCTIONS = {
  ...
  CONTRACT_CONFIG: {
    EVENT_CREATION_FEE_MJPY: 'EVENT_CREATION_FEE_MJPY',
    MJPY: 'MJPY',
    MJPY_DECIMALS: 'MJPY_DECIMALS',
